...
| Marketing (faculty) | "All you upload is your syllabus and your slides. ClassAct does the rest." | "Transform engagement and supercharge outcomes with AI-powered learning." |
| Privacy note | "You own your data. Nothing leaves this class unless you say so." | "We value your privacy." (vague, unearned) |

### Messaging Framework

- **Tagline:** *Eliminate professor pain. Create student opportunity.*
- **Homepage headline (faculty-facing):** *Eliminate professor pain. Create student opportunity.*
- **The core reframe:** *Not a pile of apps. A process.* Most classroom software hands you a drawer of disconnected tools. ClassAct is one deliberate process that lifts the work faculty dread off their plate in a way that, at every step, makes students better.
- **Value propositions:**
  1. *The chores do double duty.* Attendance, laptops, participation, group projects, grading — each becomes an occasion for students to network, engage, and learn, instead of an occasion for the professor to police them.
  2. *Zero required professor input.* Upload your syllabus and your slides; the AI drafts questions, taste files, rubrics, and rankings. The one irreducible professor act is clicking Publish on grades — no grade is ever published without professor review.
  3. *Students leave more employable.* Behavior across the term becomes eight work-readiness competencies students can see and grow — a read on who's genuinely good to work with that a GPA can't give.
- **Feature descriptions (plain):** "Check-In: students tap their seat on a live map and confirm the people around them — attendance that can't be faked, and a real introduction." "Learn Names: photo games that make the room non-anonymous by week three." "Follow Along: slides sync to every laptop and tab-aways are recorded — pause the lecture when you send them off to look something up." "Participate: think-pair-share questions the AI writes from your deck and pops in as you pass the slide." "Projects: team task boards that surface who's actually carrying the work." "Tasty Grading: students write the standard, AI drafts the ranking, peers refine it, you publish it." "My Metrics: what all of it says about a student's work readiness."
- **Objection handlers:** *"Does it work with Canvas?"* → "Connect your Canvas account once, pick your course from a list, and the roster imports with photos." *"Will my students hate it?"* → "They won't love being counted. They will care that it connects them to jobs — and in the meantime they actually meet people and learn what good work looks like." *"Is this a lot of setup?"* → "One room setup, about five minutes — or upload a photo of the room and let the AI draw it." *"Is this an AI surveillance thing?"* → "Students own their data and control what's shared. Focus tracking is visible to the student, pausable by you, and never a secret." *"Who pays for the AI?"* → "$4.99/month for the platform. Peer instruction runs on us; grading runs on your own OpenRouter key, so we never mark up your compute." *"Can I trust AI grades?"* → "You're not meant to trust them blindly — that's why the ranking is a draft, peers refine it, and nothing publishes until you click Publish."

### Elevator Pitches

- **5-second:** "It takes the classroom chores you dread and turns each one into something that makes your students better."
- **30-second:** "ClassAct is one process for in-person college classes. Students check in by tapping their seat and confirming the people around them — attendance that can't be faked, and they meet their neighbors doing it. From there the same system runs your slides, writes and launches your peer-instruction questions, watches group projects for free riders, and grades your assignments with the class writing the standard and you clicking Publish. You upload a syllabus and slides; the AI does the rest. Students come out with a work-readiness profile employers would actually want."
- **2-minute:** "Here's the problem. In a big college lecture, attendance is a joke — students click in from bed or hand a friend their clicker — the room is a hundred strangers half of them shopping online, group projects hide free riders, and grading is the slowest, loneliest work in teaching. Professors hate all of it, but they won't adopt anything that adds work, and they don't care about 'engagement' as a pitch. Students care even less — the only thing that moves them is a job. So most classrooms just stay broken. ClassAct fixes it by making every chore do double duty. Students check in by tapping their actual seat and confirming the people around them: that kills attendance fraud — you can't verify a ghost — and forces a real introduction. Name games make the room non-anonymous by week three. Slides sync to every laptop, so following along is the path of least resistance, and when you want them to go look something up, you pause the lecture and it doesn't count against anyone. The AI reads your deck and writes the peer-instruction questions, popping them in as you pass the slide. Group project boards surface who's actually carrying the work. And grading: every student writes what excellent looks like, a rubric emerges from the whole class, AI drafts the ranking, peers refine it by judging real work side by side — and nothing publishes until you click Publish. You upload a syllabus and slides. That's the ask. Why now: this failed before because it needed faculty labor nobody would give — AI finally removes that constraint. Why us: I'm a professor living this every week, I've built in this category before and learned exactly why it failed, and it's running in my own classroom. The long game is that all this behavior produces a consented, verified read on which students are genuinely great to work with — better than a GPA — and we become the bridge to employers. The ask: it's live, I'm piloting it now, and I'm looking for colleagues to run it next term."

### Competitive Differentiation Narrative

Top Hat and clickers pretend to solve attendance but any student can defeat them in five seconds — click in from home, carry a friend's device. Piazza moved discussion online and then torched its trust selling student data. Canvas and Blackboard are filing cabinets professors barely open. Gradescope speeds up marking without changing who does the judging. Every one of them ignores the physical room — where the student actually is, who they're sitting next to, whether they know a single name — and every one of them is another separate tool to adopt. ClassAct is built entirely around that room, as one process rather than a drawer of apps. Because students verify each other, attendance can't be faked the way a device can. Because checking in means meeting your neighbors, the anti-fraud mechanic is also the community mechanic. Because the class writes the grading standard and judges real work against it, grading stops being a bottleneck and becomes the lesson. And because we align incentives no one else does — real pain relief for faculty, a real path to jobs for students — both sides have a reason to actually use it. The endgame is a consented, behavior-based read on who's genuinely a great collaborator, which is a far better hiring signal than a GPA, and something no LMS is positioned to build.
