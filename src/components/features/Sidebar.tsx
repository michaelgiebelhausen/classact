...
const COURSE_NAV: NavItem[] = [
  ...
  { label: "Notes", icon: NotebookPen, seg: "notes", status: "live" },
  { label: "Ask TA", icon: GraduationCap, seg: "ta", status: "live" },
  { label: "Participate", icon: Vote, seg: "participate", status: "live" },
  { label: "Shout-outs", icon: Megaphone, seg: "shoutouts", status: "live" },
